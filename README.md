...
## 🧠 About Me
I build **real-world tools** and **automation-heavy systems**, often iteratively and fast.  
Experience spans **SOC-style monitoring, server ops, backend development**, and AI-assisted workflows, giving me practical insight into **infrastructure, automation, and security**.  

- 🧑‍💻 Software developer who likes **shipping real things**  
- 🐍 Mostly **Python**, also **TypeScript** & **HTML**  
- 🤖 Interested in **automation, agents, APIs, and systems**  
